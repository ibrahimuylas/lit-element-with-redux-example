...
class MyCounterWithReduxView extends connect(store)(PageViewElement) {
  ...
  render() {
    return html`
      <section>
        <h2>Example: simple counter with Redux</h2>
...
window.customElements.define('mmy-counter-with-redux-view', MyCounterWithReduxView);
