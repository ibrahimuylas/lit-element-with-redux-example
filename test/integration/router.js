...
describe('routing tests', function() {
  ...
  it('the page selector switches pages', async function() {
    ...
    await testNavigation(page, 'counter-with-redux', 'View Two');
    await testNavigation(page, 'shopping', 'View Three');
    await testNavigation(page, 'static-content', 'View One');
  });
  ...
  it('the page selector switches pages in a different way', async function() {
    ...
    await testNavigationInADifferentWay(page, 'counter-with-redux', 'View Two');
    await testNavigationInADifferentWay(page, 'shopping', 'View Three');
    await testNavigationInADifferentWay(page, 'static-content', 'View One');
  });
});
