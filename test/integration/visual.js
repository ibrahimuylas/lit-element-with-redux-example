...
describe('👀 page screenshots are correct', function() {
  ...
  describe('wide screen', function() {
    ...
    it('/static-content', async function() {
      return takeAndCompareScreenshot(page, 'static-content', 'wide');
    });
    it('/counter-with-redux', async function() {
      return takeAndCompareScreenshot(page, 'counter-with-redux', 'wide');
    });
    it('/shopping', async function() {
      return takeAndCompareScreenshot(page, 'shopping', 'wide');
    });
  ...
  describe('narrow screen', function() {
    ...
    it('/static-content', async function() {
      return takeAndCompareScreenshot(page, 'static-content', 'narrow');
    });
    it('/counter-with-redux', async function() {
      return takeAndCompareScreenshot(page, 'counter-with-redux', 'narrow');
    });
    it('/shopping', async function() {
      return takeAndCompareScreenshot(page, 'shopping', 'narrow');
    });
    it('/404', async function() {
